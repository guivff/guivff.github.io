window.siteData = {
  ...
  projects: [
    ...
    },
    {
      ...
      period: "2026",
      summary: "An exploratory test-time reasoning method that spends compute vertically instead of horizontally: it tries to detect the first load-bearing 'pivot' in a model's chain of thought (judge-free, from per-token entropy), clusters rollouts by their branch at that pivot, and resamples only the top-scoring branches. In an early single-seed run at a matched 16-sample budget on Qwen3-4B x AIME-2025, RBR-lite scored 53.3% vs 50.0% self-consistency and 33.3% best-of-N; these are preliminary numbers from a small study rather than a careful multi-seed evaluation. It also notes a clear limitation: where it ties the baselines, most failures are problems no sampler solves.",
